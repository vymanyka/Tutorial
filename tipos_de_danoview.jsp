...
if (key == null || key.length() == 0) { response.sendRedirect("tipos_de_danolist.jsp");}
...
<p><span class="jspmaker">Visualizar TABELA: Danos<br><br><a href="tipos_de_danolist.jsp">Voltar a lista</a></span></p>
<p>
<form>
<table border="0" cellspacing="1" cellpadding="4" bgcolor="#CCCCCC">
	<tr>
		<td bgcolor="#594FBF"><span class="jspmaker" style="color: #FFFFFF;">Descricao do dano</span>&nbsp;</td>
		<td bgcolor="#F5F5F5"><span class="jspmaker"><% out.print(x_Descricao_do_dano); %></span>&nbsp;</td>
	</tr>
	<tr>
