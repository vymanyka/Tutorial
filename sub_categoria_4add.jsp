...
try{
	...
	if (rs.getString("Login") != null){
		...
		// Open record
		String strsql = "SELECT * FROM `sub_categoria_4` WHERE 0 = 1";
		rs = stmt.executeQuery(strsql);
		rs.moveToInsertRow();
...
<p><span class="jspmaker">Adicionar TABELA: Cat.5<br><br><a href="sub_categoria_4list.jsp">Voltar a lista</a></span></p>
...
<form onSubmit="return EW_checkMyForm(this);"  action="sub_categoria_4add.jsp" method="post">
<p>
