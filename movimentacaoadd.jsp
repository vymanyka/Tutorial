...
try{
	...
	if (rs.getString("Login") != null){
		...
		// Open record
		String strsql = "SELECT * FROM `movimentacao` WHERE 0 = 1";
		rs = stmt.executeQuery(strsql);
		rs.moveToInsertRow();
...
<p><span class="jspmaker">Adicionar TABELA: Livro de ocorrencias<br><br><a href="movimentacaolist.jsp">Voltar a lista</a></span></p>
...
<form onSubmit="return EW_checkMyForm(this);"  action="movimentacaoadd.jsp" method="post">
<p>
