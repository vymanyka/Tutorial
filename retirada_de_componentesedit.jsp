...
if (request.getContentLength() > 0) {
	...
	// For other fields
	if(ht.get("x_id_Retirada_de_Componentes") != null){
		x_id_Retirada_de_Componentes = (String) ht.get("x_id_Retirada_de_Componentes");
	}else{
		x_id_Retirada_de_Componentes = "";
	}
...
<p><span class="jspmaker">Editar TABELA: Retirada de componentes<br><br><a href="retirada_de_componenteslist.jsp">Voltar a lista</a></span></p>
...
<form onSubmit="return EW_checkMyForm(this);"  name="retirada_de_componentesedit" action="retirada_de_componentesedit.jsp" method="post" enctype="multipart/form-data">
<p>
...
<table border="0" cellspacing="1" cellpadding="4" bgcolor="#CCCCCC">
	<tr>
		...
		<td bgcolor="#F5F5F5"><span class="jspmaker"><% out.print(x_id_Retirada_de_Componentes); %></span>&nbsp;</td>
	</tr>
	<tr>
