...
<p><span class="jspmaker">Editar TABELA: Fornecedores<br><br><a href="fornecedoreslist.jsp">Voltar a lista</a></span></p>
...
<form onSubmit="return EW_checkMyForm(this);"  name="fornecedoresedit" action="fornecedoresedit.jsp" method="post">
<p>
