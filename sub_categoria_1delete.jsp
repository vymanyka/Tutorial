...
String sqlKey = "`id_Um`=" + "" + key.replaceAll("'",escapeString) + "";
...
try{
	...
	if (a.equals("I")){ // Display
		String strsql = "SELECT * FROM `sub_categoria_1` WHERE " + sqlKey;
		...
		String strsql = "DELETE FROM `sub_categoria_1` WHERE " + sqlKey;
...
<p><span class="jspmaker">Apagar de TABELA: Cat.2<br><br><a href="sub_categoria_1list.jsp">Voltar a lista</a></span></p>
<form action="sub_categoria_1delete.jsp" method="post">
<p>
