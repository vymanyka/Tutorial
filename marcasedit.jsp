...
try{
	...
	if (a.equals("I")){ // Get a record to display
		...
		String strsql = "SELECT * FROM `marcas` WHERE `id_Marca`=" + tkey;
	...
	x_id_Marca = String.valueOf(rs.getLong("id_Marca"));
		...
		if (request.getParameter("x_Marca") != null){
			x_Marca = (String) request.getParameter("x_Marca");
		}else{
			x_Marca = "";
		}
...
<p><span class="jspmaker">Editar TABELA: Marcas<br><br><a href="marcaslist.jsp">Voltar a lista</a></span></p>
<script language="JavaScript" src="ew.js"></script>
<script language="JavaScript">
<!-- start Javascript
function  EW_checkMyForm(EW_this) {
if (EW_this.x_Marca && !EW_hasValue(EW_this.x_Marca, "TEXT" )) {
            if (!EW_onError(EW_this, EW_this.x_Marca, "TEXT", "Forneca o nome da marca!"))
                return false; 
        }
return true;
}
...
<form onSubmit="return EW_checkMyForm(this);"  name="marcasedit" action="marcasedit.jsp" method="post">
<p>
...
<table border="0" cellspacing="1" cellpadding="4" bgcolor="#CCCCCC">
	<tr>
		...
		<td bgcolor="#F5F5F5"><span class="jspmaker"><% out.print(x_id_Marca); %></span>&nbsp;</td>
	</tr>
	<tr>
