...
try{
	...
	if (a.equals("C")) { // Copy a record
		...
		String strsql = "SELECT * FROM `categorias` WHERE 0 = 1";
		rs = stmt.executeQuery(strsql);
		rs.moveToInsertRow();
...
<p><span class="jspmaker">Adicionar TABELA: Categorias<br><br><a href="categoriaslist.jsp">Voltar a lista</a></span></p>
...
<form onSubmit="return EW_checkMyForm(this);"  action="categoriasadd.jsp" method="post" enctype="multipart/form-data">
<p>
...
<input type="file" name="x_Imagem"></span>&nbsp;</td>
	...
	<tr>
		...
		<td bgcolor="#F5F5F5"><span class="jspmaker"><% x_Guia_do_usuario = ""; // clear Blob related fields %>
<input type="file" name="x_Guia_do_usuario"></span>&nbsp;</td>
	</tr>
	<tr>
		<td bgcolor="#594FBF"><span class="jspmaker" style="color: #FFFFFF;">Guia tecnico</span>&nbsp;</td>
		<td bgcolor="#F5F5F5"><span class="jspmaker"><% x_Guia_tecnico = ""; // clear Blob related fields %>
<input type="file" name="x_Guia_tecnico"></span>&nbsp;</td>
	</tr>
	<tr>
		<td bgcolor="#594FBF"><span class="jspmaker" style="color: #FFFFFF;">Guia rapido</span>&nbsp;</td>
		<td bgcolor="#F5F5F5"><span class="jspmaker"><% x_Guia_rapido = ""; // clear Blob related fields %>
<input type="file" name="x_Guia_rapido"></span>&nbsp;</td>
	</tr>
	<tr>
