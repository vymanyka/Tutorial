...
<p><span class="jspmaker">Editar TABELA: Cat.1<br><br><a href="sub_categoria_0list.jsp">Voltar a lista</a></span></p>
...
<form onSubmit="return EW_checkMyForm(this);"  name="sub_categoria_0edit" action="sub_categoria_0edit.jsp" method="post">
<p>
...
<table border="0" cellspacing="1" cellpadding="4" bgcolor="#CCCCCC">
	<tr>
		...
		<td bgcolor="#F5F5F5"><span class="jspmaker"><% out.print(x_id_Zero); %></span>&nbsp;</td>
	</tr>
	<tr>
