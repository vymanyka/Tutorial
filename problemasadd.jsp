...
try{
	...
	if (a.equals("C")) { // Copy a record
		...
		String strsql = "SELECT * FROM `problemas` WHERE 0 = 1";
		rs = stmt.executeQuery(strsql);
		rs.moveToInsertRow();
...
<p><span class="jspmaker">Adicionar TABELA: Problemas<br><br><a href="problemaslist.jsp">Voltar a lista</a></span></p>
...
<form onSubmit="return EW_checkMyForm(this);"  action="problemasadd.jsp" method="post" enctype="multipart/form-data">
<p>
