...
String sqlKey = "`id_Tres`=" + "" + key.replaceAll("'",escapeString) + "";
...
try{
	...
	if (a.equals("I")){ // Display
		String strsql = "SELECT * FROM `sub_categoria_3` WHERE " + sqlKey;
		...
		String strsql = "DELETE FROM `sub_categoria_3` WHERE " + sqlKey;
...
<p><span class="jspmaker">Apagar de TABELA: Cat.4<br><br><a href="sub_categoria_3list.jsp">Voltar a lista</a></span></p>
<form action="sub_categoria_3delete.jsp" method="post">
<p>
