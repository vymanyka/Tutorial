...
<p><span class="jspmaker">Editar TABELA: Componentes<br><br><a href="componenteslist.jsp">Voltar a lista</a></span></p>
...
<form onSubmit="return EW_checkMyForm(this);"  name="componentesedit" action="componentesedit.jsp" method="post">
<p>
...
<table border="0" cellspacing="1" cellpadding="4" bgcolor="#CCCCCC">
	<tr>
		...
		<td bgcolor="#F5F5F5"><span class="jspmaker"><% out.print(x_id_Componente); %></span>&nbsp;</td>
	</tr>
	<tr>
