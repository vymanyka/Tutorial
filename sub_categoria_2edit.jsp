...
try{
	...
	if (a.equals("I")){ // Get a record to display
		...
		String strsql = "SELECT * FROM `sub_categoria_2` WHERE `id_Dois`=" + tkey;
...
<p><span class="jspmaker">Editar TABELA: Cat.3<br><br><a href="sub_categoria_2list.jsp">Voltar a lista</a></span></p>
...
<form onSubmit="return EW_checkMyForm(this);"  name="sub_categoria_2edit" action="sub_categoria_2edit.jsp" method="post">
<p>
...
<table border="0" cellspacing="1" cellpadding="4" bgcolor="#CCCCCC">
	<tr>
		...
		<td bgcolor="#F5F5F5"><span class="jspmaker"><% out.print(x_id_Dois); %></span>&nbsp;</td>
	</tr>
	<tr>
