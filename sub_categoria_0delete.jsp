...
String sqlKey = "`id_Zero`=" + "" + key.replaceAll("'",escapeString) + "";
...
try{
	...
	if (a.equals("I")){ // Display
		String strsql = "SELECT * FROM `sub_categoria_0` WHERE " + sqlKey;
		...
		String strsql = "DELETE FROM `sub_categoria_0` WHERE " + sqlKey;
...
<p><span class="jspmaker">Apagar de TABELA: Cat.1<br><br><a href="sub_categoria_0list.jsp">Voltar a lista</a></span></p>
<form action="sub_categoria_0delete.jsp" method="post">
<p>
