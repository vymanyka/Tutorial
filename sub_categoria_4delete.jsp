...
String sqlKey = "`id_Quatro`=" + "" + key.replaceAll("'",escapeString) + "";
...
try{
	...
	if (a.equals("I")){ // Display
		String strsql = "SELECT * FROM `sub_categoria_4` WHERE " + sqlKey;
		...
		String strsql = "DELETE FROM `sub_categoria_4` WHERE " + sqlKey;
...
<p><span class="jspmaker">Apagar de TABELA: Cat.5<br><br><a href="sub_categoria_4list.jsp">Voltar a lista</a></span></p>
<form action="sub_categoria_4delete.jsp" method="post">
<p>
