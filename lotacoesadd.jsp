...
try{
	...
	if (rs.getString("Login") != null){
		...
		// Open record
		String strsql = "SELECT * FROM `lotacoes` WHERE 0 = 1";
		rs = stmt.executeQuery(strsql);
		rs.moveToInsertRow();
		...
		String srchfld = tmpfld;
			...
			strsql = "SELECT * FROM `lotacoes` WHERE `id_Lotacoes` = " + srchfld;
			...
			if (rschk.next()) {
				out.print("Duplicar chave para id_Lotacoes, valor = " + tmpfld + "<br>");
...
<p><span class="jspmaker">Adicionar TABELA: Lotacoes<br><br><a href="lotacoeslist.jsp">Voltar a lista</a></span></p>
...
<form onSubmit="return EW_checkMyForm(this);"  action="lotacoesadd.jsp" method="post">
<p>
