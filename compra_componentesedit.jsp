...
<p><span class="jspmaker">Editar TABELA: Compra de componentes<br><br><a href="compra_componenteslist.jsp">Voltar a lista</a></span></p>
...
<form onSubmit="return EW_checkMyForm(this);"  name="compra_componentesedit" action="compra_componentesedit.jsp" method="post">
<p>
...
<table border="0" cellspacing="1" cellpadding="4" bgcolor="#CCCCCC">
	<tr>
		...
		<td bgcolor="#F5F5F5"><span class="jspmaker"><% out.print(x_id_Compra_Componentes); %></span>&nbsp;</td>
	</tr>
	<tr>
