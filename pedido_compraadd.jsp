...
try{
	...
	if (rs.getString("Login") != null){
		...
		// Open record
		String strsql = "SELECT * FROM `pedido_compra` WHERE 0 = 1";
		rs = stmt.executeQuery(strsql);
		rs.moveToInsertRow();
		...
		String srchfld = "'" + tmpfld + "'";
			...
			strsql = "SELECT * FROM `pedido_compra` WHERE `Numero_Pedido` = '" + srchfld +"'";
			...
			if (rschk.next()) {
				out.print("Duplicar chave para Numero_Pedido, valor = " + tmpfld + "<br>");
...
<p><span class="jspmaker">Adicionar TABELA: Pedidos de compra<br><br><a href="pedido_compralist.jsp">Voltar a lista</a></span></p>
...
<form onSubmit="return EW_checkMyForm(this);"  action="pedido_compraadd.jsp" method="post">
<p>
