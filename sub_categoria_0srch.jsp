...
if (a != null && a.equals("S")) { // Get Search Criteria
	...
	if (search_criteria.length() > 0) {
		out.clear();
		response.sendRedirect("sub_categoria_0list.jsp" + "?" + search_criteria);
		response.flushBuffer();
		return;
	}
}
...
<p><span class="jspmaker">Procurar TABELA: Cat.1<br><br><a href="sub_categoria_0list.jsp">Voltar a lista</a></span></p>
<script language="JavaScript" src="ew.js"></script>
<script language="JavaScript">
<!-- start Javascript
function  EW_checkMyForm(EW_this) {
if (EW_this.x_id_Zero && !EW_checkinteger(EW_this.x_id_Zero.value)) {
        if (!EW_onError(EW_this, EW_this.x_id_Zero, "TEXT", "Numero inteiro invalido! - Codigo"))
            return false; 
        }
return true;
}
...
<form onSubmit="return EW_checkMyForm(this);"  action="sub_categoria_0srch.jsp" method="post">
<p>
...
<input type="hidden" name="z_id_Zero" value="=, , ">=
		...
		<td bgcolor="#F5F5F5"><span class="jspmaker"><input type="text" name="x_id_Zero" value="<%= HTMLEncode((String)x_id_Zero) %>"></span>&nbsp;</td>
	</tr>
	<tr>
