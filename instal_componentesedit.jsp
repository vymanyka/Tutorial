...
<p><span class="jspmaker">Editar TABELA: Instalacao de componentes<br><br><a href="instal_componenteslist.jsp">Voltar a lista</a></span></p>
...
<form onSubmit="return EW_checkMyForm(this);"  name="instal_componentesedit" action="instal_componentesedit.jsp" method="post">
<p>
