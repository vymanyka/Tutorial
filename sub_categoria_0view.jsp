...
if (key == null || key.length() == 0) { response.sendRedirect("sub_categoria_0list.jsp");}
...
<p><span class="jspmaker">Visualizar TABELA: Cat.1<br><br><a href="sub_categoria_0list.jsp">Voltar a lista</a></span></p>
<p>
<form>
