...
<p><span class="jspmaker">Editar TABELA: Danos<br><br><a href="tipos_de_danolist.jsp">Voltar a lista</a></span></p>
...
<form onSubmit="return EW_checkMyForm(this);"  name="tipos_de_danoedit" action="tipos_de_danoedit.jsp" method="post">
<p>
...
<table border="0" cellspacing="1" cellpadding="4" bgcolor="#CCCCCC">
	<tr>
		...
		<td bgcolor="#F5F5F5"><span class="jspmaker"><% out.print(x_id_Dano); %></span>&nbsp;</td>
	</tr>
	<tr>
