...
//	email :	fuushikaden@yahoo.com
	...
	var scrollLeftMessage = "Clique para mudar para o mês anterior. Pressione o botão do mouse para mudar automaticamente."
	var scrollRightMessage = "Clique para mudar para o próximo mês. Pressione o botão do mouse para mudar automaticamente."
	var selectMonthMessage = "Clique para selecionar um mês."
	var selectYearMessage = "Clique para selecionar um ano."
	var selectDateMessage = "Selecione uma data." // do not replace [date], it will be replaced by date.
