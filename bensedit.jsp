...
<p><span class="jspmaker">Editar TABELA: Bens<br><br><a href="benslist.jsp">Voltar a lista</a></span></p>
...
<form onSubmit="return EW_checkMyForm(this);"  name="bensedit" action="bensedit.jsp" method="post">
<p>
