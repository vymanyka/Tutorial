...
try{
	...
	if (rs.getString("Login") != null){
		...
		// Open record
		String strsql = "SELECT * FROM `marcas` WHERE 0 = 1";
		rs = stmt.executeQuery(strsql);
		rs.moveToInsertRow();
...
<p><span class="jspmaker">Adicionar TABELA: Marcas<br><br><a href="marcaslist.jsp">Voltar a lista</a></span></p>
...
<form onSubmit="return EW_checkMyForm(this);"  action="marcasadd.jsp" method="post">
<p>
