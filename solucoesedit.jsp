...
if (request.getContentLength() > 0) {
	...
	// For other fields
	if(ht.get("x_id_Solucao") != null){
		x_id_Solucao = (String) ht.get("x_id_Solucao");
	}else{
		x_id_Solucao = "";
	}
...
<p><span class="jspmaker">Editar TABELA: Solucoes<br><br><a href="solucoeslist.jsp">Voltar a lista</a></span></p>
...
<form onSubmit="return EW_checkMyForm(this);"  name="solucoesedit" action="solucoesedit.jsp" method="post" enctype="multipart/form-data">
<p>
...
<table border="0" cellspacing="1" cellpadding="4" bgcolor="#CCCCCC">
	<tr>
		...
		<td bgcolor="#F5F5F5"><span class="jspmaker"><% out.print(x_id_Solucao); %></span>&nbsp;</td>
	</tr>
	<tr>
