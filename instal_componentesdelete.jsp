...
String sqlKey = "`id_Instal_Componentes`=" + "" + key.replaceAll("'",escapeString) + "";
...
try{
	...
	if (a.equals("I")){ // Display
		String strsql = "SELECT * FROM `instal_componentes` WHERE " + sqlKey;
		...
		String strsql = "DELETE FROM `instal_componentes` WHERE " + sqlKey;
...
<p><span class="jspmaker">Apagar de TABELA: Instalacao de componentes<br><br><a href="instal_componenteslist.jsp">Voltar a lista</a></span></p>
<form action="instal_componentesdelete.jsp" method="post">
<p>
<input type="hidden" name="a" value="D">
<table border="0" cellspacing="1" cellpadding="4" bgcolor="#CCCCCC">
	<tr bgcolor="#594FBF">
		<td><span class="jspmaker" style="color: #FFFFFF;">Componente</span>&nbsp;</td>
		<td><span class="jspmaker" style="color: #FFFFFF;">Origem do Componente</span>&nbsp;</td>
		<td><span class="jspmaker" style="color: #FFFFFF;">Data de instalacao</span>&nbsp;</td>
		<td><span class="jspmaker" style="color: #FFFFFF;">Qtd instalada</span>&nbsp;</td>
		<td><span class="jspmaker" style="color: #FFFFFF;">Detalhes da instalacao</span>&nbsp;</td>
		<td><span class="jspmaker" style="color: #FFFFFF;">Tipo de instalacao</span>&nbsp;</td>
...
<%
	...
	Timestamp x_Data_instalacao = null;
...
%>
&nbsp;</td>
		<td class="jspmaker"><% out.print(EW_FormatDateTime(x_Data_instalacao,7,locale)); %>&nbsp;</td>
		<td class="jspmaker"><% out.print(x_Qtd_instalacao); %>&nbsp;</td>
		<td class="jspmaker"><% if (x_Detalhes_da_instalacao != null) { out.print(((String)x_Detalhes_da_instalacao).replaceAll("\r\n", "<br>"));} %>&nbsp;</td>
		<td class="jspmaker"><%
