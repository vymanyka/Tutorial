...
if (key == null || key.length() == 0) { response.sendRedirect("instal_componenteslist.jsp");}
...
<p><span class="jspmaker">Visualizar TABELA: Instalacao de componentes<br><br><a href="instal_componenteslist.jsp">Voltar a lista</a></span></p>
<p>
<form>
<table border="0" cellspacing="1" cellpadding="4" bgcolor="#CCCCCC">
	<tr>
		<td bgcolor="#594FBF"><span class="jspmaker" style="color: #FFFFFF;">Codigo</span>&nbsp;</td>
		<td bgcolor="#F5F5F5"><span class="jspmaker"><% out.print(x_id_Instal_Componentes); %></span>&nbsp;</td>
	</tr>
	<tr>
...
%>
	...
	<tr>
		...
		<td bgcolor="#F5F5F5"><span class="jspmaker"><% out.print(EW_FormatDateTime(x_Data_instalacao,7,locale)); %></span>&nbsp;</td>
	</tr>
	<tr>
		<td bgcolor="#594FBF"><span class="jspmaker" style="color: #FFFFFF;">Qtd instalada</span>&nbsp;</td>
		<td bgcolor="#F5F5F5"><span class="jspmaker"><% out.print(x_Qtd_instalacao); %></span>&nbsp;</td>
	</tr>
	<tr>
		<td bgcolor="#594FBF"><span class="jspmaker" style="color: #FFFFFF;">Detalhes da instalacao</span>&nbsp;</td>
		<td bgcolor="#F5F5F5"><span class="jspmaker"><% if (x_Detalhes_da_instalacao != null) { out.print(((String)x_Detalhes_da_instalacao).replaceAll("\r\n", "<br>"));} %></span>&nbsp;</td>
	</tr>
	<tr>
