...
if (key == null || key.length() == 0) { response.sendRedirect("sub_categoria_2list.jsp");}
...
<p><span class="jspmaker">Visualizar TABELA: Cat.3<br><br><a href="sub_categoria_2list.jsp">Voltar a lista</a></span></p>
<p>
<form>
